...
public:
    Cleric(string clericName, int clericHitPoints, int clericStrength, int clericSpeed, int clericMagic): Fighter(clericName, clericHitPoints, clericStrength, clericSpeed, clericMagic) {mana = 5 * fighterMagic;}
    ~Cleric() {}
