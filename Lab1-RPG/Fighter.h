...
protected:
    string fighterName;
    int fighterHitPoints, fighterStrength, fighterSpeed, fighterMagic, maxHitPoints, originalSpeed;
    
public:
	Fighter(string name, int hitPoints, int strength, int speed, int magic);
	virtual ~Fighter() {}
